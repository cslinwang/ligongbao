...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="/LiGongBao/jsps/css/address.css">
  ...
  <body>
      ...
      <div id="main">
           ...
           <div id="address_body">
               <form action="/LiGongBao/AddressServlet" method="POST" id="forme">
               <!-- 隐式表单提交数据 -->
               ...
               <table width="800px" height="288px" id="address_table">
                   ...
                   <tr>
                          <td>&nbsp;</td>
                          <td><a href="javascript:sube()" id="sumbit_form">保存</a></td>
                   </tr>
               </table>
               </form>
           </div>
